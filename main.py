...
integrator = Integrator(m, K, sigma)
...
for it in range(iterations):
    ...
    while True:
        info = problem.solve(verbose=verbose_solver, solver=solver, max_iters=300)
        ...
        nonlinear_cost = np.linalg.norm(new_X - integrator.integrate_nonlinear_piecewise(new_X, new_U), 1)
